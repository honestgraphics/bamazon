      ...
      if (answer.makeChoice === "Add New Product") {
        inquirer.prompt([{
          ...
          },
          {
            ...
            connection.query("INSERT INTO products (product_name, department_name, price, stock_quantity, product_sales) VALUES('" + answer.productName + "', '" + answer.departmentName + "', '" + answer.price + "', '" + answer.stockQuantity + "', '" + 0 + "')", function (err, res) {
              if (err) throw err;
